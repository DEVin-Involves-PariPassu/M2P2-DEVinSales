...
//                .antMatchers("/state").hasAuthority("estado")
//                .antMatchers("/city").hasAuthority("cidade")
//                .antMatchers("/address").hasAuthority("endereco")
//                .antMatchers("/sales").hasAuthority("venda")
//                .antMatchers("/sales").hasAuthority("entrega")
//                .antMatchers("/product").hasAuthority("produto")

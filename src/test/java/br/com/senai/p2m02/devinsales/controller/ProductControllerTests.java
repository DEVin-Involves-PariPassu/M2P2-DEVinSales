...
public class ProductControllerTests {
    ...
    @Test
    @DisplayName("Preço do produto incorreto - Bad Request")
    ...
    public void deveAtualizarOProdutoQuandoEstiverAutenticado() throws Exception {
        String body = "{\"login\":\"admin\",\"senha\":\"admin123\"}";
        MvcResult result = mockMvc
                .perform(MockMvcRequestBuilders.post("/auth")
                        .header("Content-Type", "application/json" )
        ...
        when(service.updateDoPut(anyLong(), any(ProductDTO.class))).thenReturn(1L);
    ...
    @Test
    @DisplayName("Put/Product sem autenticacao")
